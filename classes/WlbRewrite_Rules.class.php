...
class Rewrite_Rules {
    ...
    function __construct() {
        ...
        // This class only runs in the admin, but we need it initialized on init
    ...
    public static function get_link_rules($link, $type) {
        $rewrite_rules_array = self::$rewrite_rules;
		...
		$rule_array = array_shift($rewrite_rules_array);
		$rewrite_rule = key($rule_array);
